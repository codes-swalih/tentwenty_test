          ...
          <div className="flex gap-3 sm:gap-6 lg:gap-7 items-center">
            <div className="w-[10rem] sm:w-[7rem] lg:w-[8.8rem] h-[10rem] sm:h-[7rem] lg:h-[8.8rem]">
              ...
              <div className="flex w-full h-full absolute top-0 left-0">
                ...
                >
                  <div className="w-40 md:w-[40%] -ml-[224px] md:-ml-[198.5px] sm:-ml-[198.5px] relative my-auto h-40 sm:h-full flex items-center justify-center border-[0.5px] border-gray-500">
                    <div className="relative my-auto ml-2 md:ml-0  w-[68%] h-[68%] z-20">
                      {[
